  ...
  return (
    ...
    >
      <div className="w-full max-w-6xl flex flex-col md:grid md:grid-cols-2 gap-6 items-center h-full">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start px-4 md:mb-18 gap-6">
          ...
          <div className="order-1 md:order-2">
            <motion.h2
              className="text-[1.5em] md:text-4xl font-bold leading-tight mb-4 md:mr-5 mt-10 md:mt-0 text-center md:text-left md:flex-1"
            ...
            <motion.p
              className="text-black text-xs leading-snug md:hidden ml-35 mr-10"
        ...
        <div className="flex flex-col justify-center px-4">
          <div className="space-y-2">
            {benefits.map((b, i) => (
              ...
              >
                <h4 className="text-[0.61em] md:text-[1.05em] mr-2 ml-34 md:mr-0 md:ml-0">
                  ● {b.title}
