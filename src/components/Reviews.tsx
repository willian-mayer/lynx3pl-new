...
export default function Reviews() {
  ...
  return (
    <section
      ...
      "
    >
      <div className="w-full max-w-4xl mx-auto grid md:grid-cols-2 gap-2">
        ...
        >
          <p className="text-black text-[1.8em] md:text-6xl font-bold mb-2 text-center">
            <span className="text-red-700">“</span>{mainReview.review} <span className="text-red-700">”</span>
          </p>
  ...
  {reviews.map((r, i) => (
    ...
    >
      <div className="flex items-start justify-end ">
        ...
        <p className="text-black text-xs md:text-sm font-semibold text-start">“{r.review}”</p>
      </div>
      <p className="w-full text-xs text-red-700 font-semibold text-start my-1 pl-28">
